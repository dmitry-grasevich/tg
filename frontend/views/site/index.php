<div class="menu" id="menu">
    ...
    <div class="main" id="main">
        ...
        <h3><span class="fui-list"></span> Elements</h3>

        <ul id="elements">
            <li><a href="#" id="all">All Elements</a></li>
        </ul>
        ...
        <div class="sideButtons clearfix">
            ...
            <a href="#exportModal" data-toggle="modal"
               class="btn btn-info btn-sm btn-embossed disabled actionButtons"><span class="fui-export"></span>
                Export</a>
        </div>
