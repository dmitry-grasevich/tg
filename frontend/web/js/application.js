...
//    $(".tagsinput").tagsInput();
        ...
        var $slider3 = $("#slider3"), slider3ValueMultiplier = 100, slider3Options;
        ...
        $('.table tbody :checkbox').on('check uncheck toggle', function (e) {
            var $this = $(this), check = $this.prop('checked'), toggle = e.type == 'toggle', checkboxes = $('.table tbody :checkbox'), checkAll = checkboxes.length == checkboxes.filter(':checked').length;
