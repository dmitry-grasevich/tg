...
class Pronamic_Google_Maps_Settings
{
                ...
                <?php foreach ($post_types as $name => $type) : ?>
                    ...
                    <li>
                        <label for="pronamic-google-maps-type-<?php echo $name; ?>">
                            <input id="pronamic-google-maps-type-<?php echo $name; ?>"
                                   name="Pronamic_Google_maps[active][<?php echo $name; ?>]" value="true"
                                   type="checkbox" <?php checked(self::is_active_post_type($name)); ?> />
    ...
    public function setting_google_maps_visual_refresh($args)
    {
        ...
        <label for="pronamic_google_maps_visual_refresh">
            <input id="pronamic_google_maps_visual_refresh" name="pronamic_google_maps_visual_refresh" value="true"
                   type="checkbox" <?php checked(get_option('pronamic_google_maps_visual_refresh')); ?> />
