...
class Pronamic_Google_Maps_Admin
{
    ...
    public static function bootstrap()
    {
        ...
        wp_register_script(
            ...
            Pronamic_Google_Maps_Maps::$pluginsUrl . 'js/admin.js',
        ...
        wp_register_style(
            'pronamic_google_maps_admin',
            Pronamic_Google_Maps_Maps::$pluginsUrl . 'css/admin.css'
        );
    ...
    public static function menu()
    {
        add_menu_page(
            ...
            Pronamic_Google_Maps_Maps::$pluginsUrl . 'images/icon-16x16-v2.png' // icon url
        );
