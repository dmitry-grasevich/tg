(function ($) {
    ...
    var PronamicGoogleMapsMetaBox = function (element, options) {
        ...
        fields.description.keyup(function () {
            infoWindow.setContent(fields.description.val());
        });
        fields.description.change(function () {
            infoWindow.setContent(fields.description.val());
        });
    };
    ...
    var PronamicGoogleMapsWidget = function (element, options) {
        ...
        element.closest(".widget").find(".widget-action").click(function () {
