...
<form autocomplete="off" method="post"
      action="<?php echo esc_url(add_query_arg(array('screen' => 'edit_controls'), $this->admin_url)); ?>">
    <?php
    /**
     ...
     */
        ...
        <div class="manage-controls control-dialog">
            <label
                class="manage-label"><?php _e('Manage your custom font controls here or:', $this->plugin_slug); ?></label>
            <label
                class="new-label"><?php _e('Create a new font control for your theme:', $this->plugin_slug); ?></label>
            <?php submit_button(__('Create a New Font Control', $this->plugin_slug), 'secondary', 'create_new_control', false, array('data-create-control-url' => $this->create_url)); ?>
        </div><!-- /.control-dialog -->
                ...
                <tr class="<?php echo $row_class; ?>">
                    <td class="post-title page-title column-title">
                        ...
                        <div class="row-actions">
                            <a data-control-reference="<?php echo $control_id; ?>" class="control-edit-link"
                               href="<?php echo $edit_link; ?>"><?php _e('Edit', $this->plugin_slug); ?></a> | <a
                                data-control-reference="<?php echo $control_id; ?>" class="control-delete-link"
                                href="#"><?php _e('Delete', $this->plugin_slug); ?></a>
                        </div>
                    </td>
                    <td class=""><?php echo $selector_output; ?></td>
                    <td class=""><input autocomplete="off" data-control-reference="<?php echo $control_id; ?>"
                                        class="tt-force-styles"
                                        type="checkbox" <?php checked($force_styles, 'true'); ?>></td>
