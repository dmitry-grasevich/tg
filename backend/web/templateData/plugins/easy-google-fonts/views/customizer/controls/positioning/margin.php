...
<div class="tt-font-toggle">
    ...
    <div class="toggle-section-content">
        ...
        <div class="tt-font-slider-control margin-slider margin-top-slider">
            ...
            <input autocomplete="off" class="tt-font-slider-amount" type="hidden"
                   data-default-value="<?php echo $default_amount_top; ?>" value="<?php echo $current_amount_top; ?>"/>
            <input autocomplete="off" class="tt-font-slider-unit" type="hidden"
                   data-default-value="<?php echo $default_unit_top; ?>" value="<?php echo $default_unit_top; ?>"/>

            <div class="clearfix"></div>

        </div>
        <!-- END .tt-font-slider-control -->
        ...
        <div class="tt-font-slider-control margin-slider margin-bottom-slider">
            ...
            <input autocomplete="off" class="tt-font-slider-amount" type="hidden"
                   data-default-value="<?php echo $default_amount_bottom; ?>"
                   value="<?php echo $current_amount_bottom; ?>"/>
            <input autocomplete="off" class="tt-font-slider-unit" type="hidden"
                   data-default-value="<?php echo $default_unit_bottom; ?>"
                   value="<?php echo $default_unit_bottom; ?>"/>
        ...
        <div class="tt-font-slider-control margin-slider margin-left-slider">
            ...
            <input autocomplete="off" class="tt-font-slider-amount" type="hidden"
                   data-default-value="<?php echo $default_amount_left; ?>"
                   value="<?php echo $current_amount_left; ?>"/>
            <input autocomplete="off" class="tt-font-slider-unit" type="hidden"
                   data-default-value="<?php echo $default_unit_left; ?>" value="<?php echo $default_unit_left; ?>"/>
        ...
        <div class="tt-font-slider-control margin-slider margin-right-slider">
            ...
            <input autocomplete="off" class="tt-font-slider-amount" type="hidden"
                   data-default-value="<?php echo $default_amount_right; ?>"
                   value="<?php echo $current_amount_right; ?>"/>
            <input autocomplete="off" class="tt-font-slider-unit" type="hidden"
                   data-default-value="<?php echo $default_unit_right; ?>" value="<?php echo $default_unit_right; ?>"/>
