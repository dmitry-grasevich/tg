...
<div class="customize-control-content tt-background-color-container">
    <input autocomplete="off" class="tt-color-picker-hex" data-default-color="<?php echo $default_color; ?>"
           value="<?php echo $current_color; ?>" type="text" maxlength="7"
           placeholder="<?php esc_attr_e('Hex Value', 'easy-google-fonts'); ?>"/>
</div>
